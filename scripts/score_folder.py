...
from chain_quality import dedup_consecutive_len, load_goal_sequence, unique_points
...
def main():
    ...
    unique, dedup = [], []
    print(f"{'file':<45} {'unique_points':>13} {'dedup_len':>10}")
    for f in files:
